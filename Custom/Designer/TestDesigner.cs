...
{
    /// <summary>
    /// Represents a designer for the <typeparamref name="SitefinityWebApp.Custom.Widgets.TestControl"/> widget
    /// </summary>
    public class TestDesigner : ControlDesignerBase
    {
        #region Properties
        /// <summary>
        ...
        public override string LayoutTemplatePath
        {
            get
            {
                if (string.IsNullOrEmpty(base.LayoutTemplatePath))
                    return TestDesigner.layoutTemplatePath;
        ...
        public override System.Collections.Generic.IEnumerable<System.Web.UI.ScriptReference> GetScriptReferences()
        {
            ...
            scripts.Add(new ScriptReference(TestDesigner.scriptReference));
            return scripts;
        }
        #endregion

        #region Private members & constants
        public static readonly string layoutTemplatePath = "~/Custom/Designer/TestDesigner.ascx";
        public const string scriptReference = "~/Custom/Designer/TestDesigner.js";
        #endregion
    }
}

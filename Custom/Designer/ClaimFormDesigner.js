...
SitefinityWebApp.Custom.Designer.ClaimFormDesigner = function (element) {
    ...
    SitefinityWebApp.Custom.Designer.ClaimFormDesigner.initializeBase(this, [element]);
}

SitefinityWebApp.Custom.Designer.ClaimFormDesigner.prototype = {
    /* --------------------------------- set up and tear down --------------------------------- */
    initialize: function () {
        /* Here you can attach to events or do other initialization */
        SitefinityWebApp.Custom.Designer.ClaimFormDesigner.callBaseMethod(this, 'initialize');
    },
    dispose: function () {
        /* this is the place to unbind/dispose the event handlers created in the initialize method */
        SitefinityWebApp.Custom.Designer.ClaimFormDesigner.callBaseMethod(this, 'dispose');
    },
...
SitefinityWebApp.Custom.Designer.ClaimFormDesigner.registerClass('SitefinityWebApp.Custom.Designer.ClaimFormDesigner', Telerik.Sitefinity.Web.UI.ControlDesign.ControlDesignerBase);
